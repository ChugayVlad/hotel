...
<div class="order-wrapper bg-light">
    ...
    <form class="row g-3" id="sort" action="controller" method="get">
        ...
        <div class="col-auto">
            <input type="submit" class="btn btn-primary" value="<fmt:message key="main_jsp.form.sort.submit_sort"/>">
        </div>
    </form>
    ...
    <nav>
        <ul class="pagination">
            <li class="page-item"><util:pagination path="controller?command=showRooms" page="${page}"
                                                   pageSize="${pageSize}" maxPage="${maxPage}"/></li>
        </ul>
    </nav>
</div>
</body>
